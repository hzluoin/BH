<template>
  <div class="bh-update_phone_lost">
    ...
    <el-row>
      <el-col :span="24">
        <span class="bg-F4FBFF ft16 color-0BB2FE">登录密码修改</span>
      </el-col>
    </el-row>

    <el-row>
      <el-col :span="4" type="flex">
        <span class="bh-col_1 ft14 color-333">原密码</span>
      </el-col>
      <el-col :span="7">
    ...
    <el-row>
      <el-col type="flex" :span="4" >
        <span class="bh-col_1 ft14 color-333">{{user.telephone ? '短信' : '邮箱'}}验证码</span>
      </el-col>
      <el-col :span="7">
